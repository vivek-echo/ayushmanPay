                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row m-0">
                            ...
                            <div class="form-group col-6">
                                <label class="col-form-label">Date Of Death</label><span
                                    class="text-danger fa-lg font-weight-500">
                                    *</span>
                                <div class="input-group">
                                    <input class="datepicker-here form-control digits" type="text" data-language="en"
                            ...
                            <div class="form-group col-6">
                                <label class="col-form-label">Place Of Death</label><span
                                    class="text-danger fa-lg font-weight-500">
                                    *</span>
                                <input name="DeathPlace" id="DeathPlace" class="form-control" type="text"
                            ...
                            <div class="form-group col-6">
                                <label class="col-form-label">Husband / Spouse Name</label><span
                                    class="text-danger fa-lg font-weight-500">
                                    *</span>
                                <input name="MotherAadharno" id="MotherAadharno" class="form-control" type="text"
                                    placeholder="Enter Husband / Spouse Name" autocomplete="off">
